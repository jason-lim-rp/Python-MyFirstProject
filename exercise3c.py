...
for row in rows:
    if row['type_of_public_transport'] == 'MRT':
        mrt.append(int(row['average_ridership']))
        year.append(row['year'])
    elif row['type_of_public_transport'] == 'Bus':
        bus.append(int(row['average_ridership']))
    elif row['type_of_public_transport'] == 'Taxi':
        taxi.append(int(row['average_ridership']))
    elif row['type_of_public_transport'] == 'LRT':
        lrt.append(int(row['average_ridership']))
...
chart.add_series({
    'name' : '=Sheet1!$C$1',
    'categories' : '=Sheet1!$A$2:$A$23',
    'values' : '=Sheet1!$C$2:$C$23'
})
chart.add_series({
    'name' : '=Sheet1!$D$1',
    'categories' : '=Sheet1!$A$2:$A$23',
    'values' : '=Sheet1!$D$2:$D$23'
})
chart.add_series({
    'name' : '=Sheet1!$E$1',
    'categories' : '=Sheet1!$A$2:$A$23',
    'values' : '=Sheet1!$E$2:$E$23'
})
